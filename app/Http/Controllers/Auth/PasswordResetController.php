    ...
    public function sendResetCode(Request $request)
    {
        ...
        try {
            Mail::send([], [], function ($message) use ($email, $otp, $resetUrl) {
                $message->to($email)
                    ->subject('OdjaMi — Réinitialisation de votre mot de passe')
                    ->html("
                        <div style=\"font-family: 'Inter', sans-serif; max-width: 550px; margin: 0 auto; padding: 30px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;\">
                            <div style=\"text-align: center; margin-bottom: 24px;\">
                                <h2 style=\"color: #105e49; font-weight: 800; font-size: 24px; margin: 0 0 8px 0;\">OdjaMi</h2>
                            ...
                            <p style=\"color: #4b5563; font-size: 15px; line-height: 1.5; margin: 0 0 20px 0;\">
                                Bonjour,<br><br>Vous avez demandé la réinitialisation de votre mot de passe pour votre compte OdjaMi. Voici votre code de validation à usage unique (OTP) :
                            </p>
