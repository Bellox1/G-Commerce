...
@section('subtitle', 'Créez une nouvelle société pour votre client')
...
<form action="{{ route('prestataire.tenants.store') }}" method="POST" data-no-api="true">
    @csrf
            ...
            <div class="card">
                ...
                <div class="form-row form-row-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="activite" class="form-control" value="{{ old('activite') }}" placeholder="Ex : Import / Export">
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div style="margin-top: 24px;">
                    <button type="submit" class="btn btn-primary" style="width: 100%;">
                        <i class="bi bi-check-circle-fill"></i> Créer la Société
                    </button>
                </div>
            </div>
        </div>
