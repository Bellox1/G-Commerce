...
export const COMMISSION_STATUS = {
    en_attente: { label: 'En attente', color: Colors.warning, bg: Colors.warning + '20' },
    reglee: { label: 'Réglée', color: Colors.success, bg: Colors.success + '20' },
};

export const PRESTATAIRE_STATUS = {
    en_attente: { label: 'En attente', color: Colors.warning, bg: Colors.warning + '20' },
    approuve: { label: 'Approuvé', color: Colors.success, bg: Colors.success + '20' },
    rejete: { label: 'Rejeté', color: Colors.error, bg: Colors.error + '20' },
};
